...
When running the agent in interactive mode (`heris`), the following commands are available:
...
1.  Create a new tool file under `heris/tools/`.
...
from heris.tools.my_tool import MyTool
