# Heris Configuration Setup Script for Windows
# This script helps you set up Heris configuration files
...
$CONFIG_DIR = Join-Path $env:USERPROFILE ".heris\config"

Write-ColorOutput "==================================================" -Color "Cyan"
Write-ColorOutput "   Heris Configuration Setup" -Color "Cyan"
Write-ColorOutput "==================================================" -Color "Cyan"
Write-Host ""
...
if (Test-Path $CONFIG_DIR) {
    ...
    $BACKUP_DIR = Join-Path $env:USERPROFILE ".heris\config.backup.$timestamp"
...
$FILES_COPIED = 0
$GITHUB_RAW_URL = "https://raw.githubusercontent.com/MiniMax-AI/heris/main/heris/config"
...
Write-Host ""
Write-ColorOutput "1. Install Heris:" -Color "Yellow"
Write-ColorOutput "   uv tool install -e ." -Color "Green"
Write-Host ""
...
Write-Host ""
Write-ColorOutput "3. Start using Heris:" -Color "Yellow"
Write-ColorOutput "   heris                              # Use current directory" -Color "Green"
Write-ColorOutput "   heris --workspace C:\path\to\project # Specify workspace" -Color "Green"
Write-ColorOutput "   heris --help                      # Show help" -Color "Green"
Write-Host ""
