...
class Config(BaseModel):
    ...
    def get_package_dir() -> Path:
        ...
        Returns:
            Path to the heris package directory
        """
    ...
    def find_config_file(cls, filename: str) -> Path | None:
        ...
        1) heris/config/{filename} in current directory (development mode)
        2) ~/.heris/config/{filename} in user home directory
        3) {package}/heris/config/{filename} in package installation directory
